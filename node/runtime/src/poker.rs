use crate::{naive_rsa, stage, cards, keys, ranking};
use stage::StageId;
...
impl<T: Trait> Module<T> {
	...
	fn determine_winner(dealer: T::AccountId, player: T::AccountId) -> Result {
	...
	fn validate_revealed_cards(stage: u32, cards: &[u8]) -> Result {
